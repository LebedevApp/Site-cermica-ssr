                ...
                >
                  <transition name="fade" mode="out-in">
                    ...
                    <div v-else>
                      <v-card class="ma-8">
                        <v-card-title
                          class="mt-8 mx-5 text-h4 font-weight-black"
                          >Logo</v-card-title
                        >
                        <v-divider></v-divider>
                        <p class="py-16 mx-3 font-weight-light">
                          ...
                          корни уходят в один фрагмент классической латыни 45
                          года н.э., то есть более двух тысячелетий назад.
                          Ричард МакКлинток, профессор латыни из колледжа
                          Hampden-Sydney, штат Вирджиния, взял одно из самых
                          странных слов в Lorem Ipsum
                        </p>
...
.menu {
  width: 100%;
  height: 100%;
  background-color: rgba(117, 193, 255, 0.7);
