<template>
  <v-row class="py-3" align="center">
      ...
      <v-list color="rgba(0,0,0,0)">
        <v-list-item-content class="white--text">
          ...
          >
            ...
            {{ content.subtitle }}
            <v-icon color="white" class="ml-3">mdi-star</v-icon></v-list-item-subtitle
          >
        </v-list-item-content>
    ...
    <v-col cols="12" lg="7" md="7" sm="12" class="desctop" style="perspective: 1000px;">


      <div class="card3d px-10 py-16" @mousemove="create3d" @mouseleave="stop3d" @mouseenter="start3d">
        <div class="card3d_map" ref="map">
          <img class="img" src="russia-map.png" alt="" ref="img" />
          <img src="../static/ru_wikipedia_org_-min.jpg" alt="" class="ros" ref="ros">
          <img src="../static/1061px-Flag_of_N.png" alt="" class="gas" ref="gas">
    ...
    <v-col cols="12" lg="7" md="7" sm="12" class="mobile" style="perspective: 1000px;">


      <img src="../static/russia-map.png" alt="" class="img">
